"""
Django settings for napoliclub_backend project.
...
SECRET_KEY = 'django-insecure--5ela^67fb9c*g-srh6js&vv9t3&8r9q8!3kh0xmx1@w(ksif_'
...
WSGI_APPLICATION = 'napoliclub_backend.wsgi.application'
